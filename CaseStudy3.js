...
//         E = >20
//     */
// // var input = parseInt(prompt('Masukkan nilai mahasiswa '));

// // nilaiPeserta(input);
// document.write(dataSiswa);

// function nilaiPeserta (nilai) {
//             if (nilai < 20){
//                 document.write('Nilai peserta dengan nama ', dataSiswa[i][0],' memiliki nilai E');
//             }else if (nilai>=20 && nilai<40){
//                 document.write('Nilai peserta dengan nama ', dataSiswa[i][0],' memiliki nilai D');
//             }else if (nilai>=40 && nilai<60){
//                 document.write('Nilai peserta dengan nama ', dataSiswa[i][0],' memiliki nilai C');
//             }else if (nilai>=60 && nilai<80){
//                 document.write('Nilai peserta dengan nama ', dataSiswa[i][0],' memiliki nilai B');
//             }else if (nilai>=80 && nilai<100){
//                 document.write('Nilai peserta dengan nama ', dataSiswa[i][0],' memiliki nilai A');
//             }else {
//                 document.write('Nilai diluar range');
//             };
// };
